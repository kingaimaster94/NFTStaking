...
import "./interfaces/IKryptoNFTToken.sol";
import "./interfaces/IKryptoNFT.sol";

/// @title the KryptoNFT NFT staking vault
/// @author kaymen99
/// @notice this vault allwos users to stake their KryptoNFT tokens and earn daily rewards
/// based on their overall staking period, the rewards are distributed in the form of our own ERC20 token 'KryptoNFTToken'
/// @dev this contract must be set as controller in the 'KryptoNFTToken' contract to enable ERC20 rewards minting
...
contract NFTStakingVault is IERC721Receiver {
    ...
    IKryptoNFT immutable nft;
    IKryptoNFTToken immutable token;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IKryptoNFT(_nftAddress);
        token = IKryptoNFTToken(_tokenAddress);
    }
